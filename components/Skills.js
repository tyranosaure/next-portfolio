...
function Skills() {
	return (
		<motion.div
			...
			className="relative h-screen flex flex-col text-center md:text-left md:max-w-7xl xl:px-10 justify-center min-h-screen xl:space-y-0 mx-auto overflow-hidden pr-4 py-24"
		>
